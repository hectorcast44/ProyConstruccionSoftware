...
(function (global) {
  ...
  // js/ui-helpers.js  (dentro del IIFE)
  const TagStyleManager = (function () {
    // 15 colores pastel
  const PALETTE = [
    'tag-rojo',        // rojo
    'tag-azul',        // azul pastel fuerte
    'tag-amarillo',    // amarillo suave
    'tag-morado',      // morado vivo
    'tag-naranja',     // naranja pastel
    'tag-agua',        // azul-agua contrastante
    'tag-magenta',     // magenta
    'tag-verde',       // verde suave
    'tag-rosa',        // rosa pastel
    'tag-azul-claro',  // azul claro
    'tag-melocoton',   // durazno suave
    'tag-lavanda',     // lavanda suave
    'tag-verde-lima',  // verde brillante
    'tag-dorado',      // amarillo/dorado suave
    'tag-durazno'      // durazno más intenso
  ];
